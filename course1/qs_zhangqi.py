...
x = [2, 20, 1, 15, 3, 11, 13, 6, 16, 10, 19, 5, 4, 9, 8, 14, 18, 17, 7, 12]
# ia3, num3 = QS3(x)
print(num1)
print(num2)
print(num3)
# this works!
# https://github.com/zhangqi-chen/Algorithms-Stanford/tree/master/1%20Divide%20and%20Conquer%2C%20Sorting%20and%20Searching%2C%20and%20Randomized%20Algorithms